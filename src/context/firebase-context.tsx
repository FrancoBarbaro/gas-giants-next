...
export const FirebaseContext = createContext<ContextType>({ authToken: null, appCheckToken: null });
...
export const FirebaseContextProvider: FC<FirebaseContextProviderProps> = ({ children }) => {
	...
	return <FirebaseContext.Provider value={{ authToken, appCheckToken }}>{children}</FirebaseContext.Provider>;
};
